...
## Edit website / Modifica sito

Open **Admin → Edit website** to update public website content visually.

### Basic workflow

1. Choose the page from the toolbar.
2. Choose **IT** or **EN** for the preview language.
3. Choose **Desktop**, **Tablet**, or **Mobile** to check the layout.
4. Click a text, image, logo, or card area in the preview.
5. Use the inspector on the right to edit the selected item.
6. Always check both **Italiano** and **English** fields before saving.
7. Click **Save selected** for one item, or **Save all** for all draft changes.
8. Click **Open public site** to verify the result as a visitor.

### What can be edited safely

You can edit:

- homepage title, subtitle, and main buttons;
- experience page title and intro;
- experience card titles, summaries, descriptions, value, notes, safety text, and images;
- upcoming excursions page title and intro;
- partnerships page title and intro;
- About us title, team bios, and team images;
- mission and vision text;
- reviews title, intro, and review button label;
- contact page title and intro;
- the main logo image, if Supabase Storage is configured.

### Safe style controls

The editor only allows controlled brand-safe options:

- text size: Small, Normal, Large, Hero;
- text style: Label, Body, Heading, Display heading;
- alignment: Left or Center;
- image position: Center, Top, Bottom;
- image size: Compact, Normal, Large;
- visible/hidden.

There is no free drag-and-drop editing, arbitrary CSS, random font upload, or pixel-level positioning. This protects the premium vulcanIQ layout.

### Good editing rules

- Update Italian and English together.
- Use high-quality horizontal images for wide website areas.
- Use clear alt text for images.
- Use **Hide** or visibility controls instead of deleting content when unsure.
- Do not remove important contact information unless it is repeated clearly elsewhere.
- If Supabase is not configured, you can preview the fallback website but cannot save changes.

### Cards and structured data

Some visible cards are connected to structured admin data:

- fixed excursions are managed from the calendar/fixed excursion admin area;
- partnerships are managed from the partnerships admin area;
- finance and private booking data are never exposed inside the visual website editor.

Inside the visual editor, click directly on text or images inside cards to edit visual copy/media. Use the dedicated admin sections for structured data such as capacity, dates, booking details, or partnership records.
