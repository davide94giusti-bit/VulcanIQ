-- VulcanIQ foundational schema as it existed at commit d00bd79, immediately before recorded migrations were introduced.
-- This migration makes that pre-history state reproducible on a fresh Supabase database.
